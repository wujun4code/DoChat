...
export var Wrapper_DiscoverPage = (function () {
    function Wrapper_DiscoverPage(p0) {
        this.changed = false;
        this.context = new import0.DiscoverPage(p0);
    }
    Wrapper_DiscoverPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_DiscoverPage;
}());
var renderType_DiscoverPage_Host = null;
var _View_DiscoverPage_Host0 = (function (_super) {
    __extends(_View_DiscoverPage_Host0, _super);
    function _View_DiscoverPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_DiscoverPage_Host0, renderType_DiscoverPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_DiscoverPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-discover', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_DiscoverPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._DiscoverPage_0_4 = new Wrapper_DiscoverPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._DiscoverPage_0_4.context, [], compView_0);
        compView_0.create(this._DiscoverPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_DiscoverPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.DiscoverPage) && (0 === requestNodeIndex))) {
            return this._DiscoverPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_DiscoverPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._DiscoverPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_DiscoverPage_Host0;
}(import1.AppView));
function viewFactory_DiscoverPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_DiscoverPage_Host === null)) {
        (renderType_DiscoverPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_DiscoverPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var DiscoverPageNgFactory = new import10.ComponentFactory('page-discover', viewFactory_DiscoverPage_Host0, import0.DiscoverPage);
var styles_DiscoverPage = [];
var renderType_DiscoverPage = null;
var _View_DiscoverPage0 = (function (_super) {
    __extends(_View_DiscoverPage0, _super);
    function _View_DiscoverPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_DiscoverPage0, renderType_DiscoverPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_DiscoverPage0.prototype.createInternal = function (rootSelector) {
    ...
    _View_DiscoverPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_DiscoverPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_DiscoverPage0.prototype.destroyInternal = function () {
        this._Content_9_4.context.ngOnDestroy();
    };
    return _View_DiscoverPage0;
}(import1.AppView));
export function viewFactory_DiscoverPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_DiscoverPage === null)) {
        (renderType_DiscoverPage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_DiscoverPage, {}));
    }
    return new _View_DiscoverPage0(viewUtils, parentInjector, declarationEl);
}
