...
export class Wrapper_DiscoverPage {
...
var renderType_DiscoverPage_Host:import2.RenderComponentType = (null as any);
class _View_DiscoverPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _DiscoverPage_0_4:Wrapper_DiscoverPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_DiscoverPage_Host0,renderType_DiscoverPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-discover',rootSelector,(null as any));
    this._appEl_0 = new import3.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_DiscoverPage0(this.viewUtils,this.injector(0),this._appEl_0);
    this._DiscoverPage_0_4 = new Wrapper_DiscoverPage(this.parentInjector.get(import8.NavController));
    this._appEl_0.initComponent(this._DiscoverPage_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._DiscoverPage_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.DiscoverPage) && (0 === requestNodeIndex))) { return this._DiscoverPage_0_4.context; }
...
function viewFactory_DiscoverPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_DiscoverPage_Host === (null as any))) { (renderType_DiscoverPage_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_DiscoverPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const DiscoverPageNgFactory:import10.ComponentFactory<import0.DiscoverPage> = new import10.ComponentFactory<import0.DiscoverPage>('page-discover',viewFactory_DiscoverPage_Host0,import0.DiscoverPage);
const styles_DiscoverPage:any[] = ([] as any[]);
var renderType_DiscoverPage:import2.RenderComponentType = (null as any);
class _View_DiscoverPage0 extends import1.AppView<import0.DiscoverPage> {
  _el_0:any;
  ...
  /*private*/ _expr_2:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_DiscoverPage0,renderType_DiscoverPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
...
export function viewFactory_DiscoverPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.DiscoverPage> {
  if ((renderType_DiscoverPage === (null as any))) { (renderType_DiscoverPage = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,styles_DiscoverPage,{})); }
