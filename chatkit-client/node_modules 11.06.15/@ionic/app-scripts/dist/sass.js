...
function sass(context, options, sassConfig, useCache) {
    ...
    sassConfig = config_1.fillConfigDefaults(context, sassConfig, SASS_TASK_INFO);
...
function sassUpdate(event, path, context, options, useCache) {
    if (useCache === void 0) { useCache = false; }
    logger_1.Logger.debug("sassUpdate, event: " + event + ", path: " + path);
    var sassConfig = config_1.fillConfigDefaults(context, null, SASS_TASK_INFO);
    ...
    return new Promise(function (resolve, reject) {
        ...
        nodeSass.render(sassConfig, function (renderErr, sassResult) {
            if (renderErr) {
                // sass render error!
                if (renderErr.line) {
                    logger_1.Logger.error("Sass Error: line: " + renderErr.line + ", column: " + renderErr.column + "\n" + renderErr.message);
                }
                else {
