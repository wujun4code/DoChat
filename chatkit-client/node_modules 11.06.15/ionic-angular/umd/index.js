(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", './module', './directives', './gestures/drag-gesture', './gestures/gesture', './gestures/slide-edge-gesture', './gestures/slide-gesture', './gestures/gesture-controller', './util/click-block', './util/events', './util/keyboard', './util/form', './util/util', './animations/animation', './transitions/page-transition', './transitions/transition', './translation/translate', './translation/translate_pipe'], factory);
    }
