...
import * as import3 from './discover';
...
var _View_DiscoverPage_Host0 = (function (_super) {
    ...
    _View_DiscoverPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._DiscoverPage_0_4 = new import3.DiscoverPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._DiscoverPage_0_4, [], compView_0);
        compView_0.create(this._DiscoverPage_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_DiscoverPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.DiscoverPage) && (0 === requestNodeIndex))) {
            return this._DiscoverPage_0_4;
        }
...
export var DiscoverPageNgFactory = new import10.ComponentFactory('page-discover', viewFactory_DiscoverPage_Host0, import3.DiscoverPage);
